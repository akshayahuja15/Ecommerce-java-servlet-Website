...
<%@ page import="com.akshay.service.impl.*,com.akshay.service.*"%>
...
<div class="container-fluid text-center" style="margin-top: 58px; background-color: #000000; color: white; padding: 5px;">
    <img src="images/logo.png" alt="UPES MART LOGO" width="200">
    <h6>You Demand We Serve</h6>
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a href="index.jsp"><img src="images/logo.png" alt="UPES MART LOGO" width="130"></a>
			</div>
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a href="userHome.jsp"><img src="images/logo.png" alt="UPES MART LOGO" width="130"></a>
			</div>
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a href="adminViewProduct.jsp"><img src="images/logo.png" alt="UPES MART LOGO" width="130"></a>
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
