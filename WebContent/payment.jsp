...
<%@ page
	import="com.akshay.service.impl.*,com.akshay.service.*,com.akshay.beans.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*"%>
<!DOCTYPE html>
<html>
<head>
			...
			<form action="./OrderServlet" method="post"
				...
				<div style="font-weight: bold;" class="text-center">
					<div class="form-group">
						...
						<h2 style="color: green;">Card Payment</h2>
					</div>
				</div>
				<div class="row">
