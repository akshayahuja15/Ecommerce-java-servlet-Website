...
public class MailMessage {
	public static void registrationSuccess(String emailId, String name) {
		...
		String htmlTextMessage = "" + "<html>" + "<body>"
				+ "<h2 style='color:green;'>Welcome to UPES MART</h2>" + "" + "Hi " + name + ","
				+ "<br><br>Thanks for singing up with UPES MART<br>"
				...
				+ "to enter the promo code given below.<br><br><br> PROMO CODE: " + "UPES500<br><br><br>"
	...
	public static void transactionSuccess(String recipientEmail, String name, String transId, double transAmount) {
		...
		String subject = "Order Placed at UPES MART";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with UPES MART!" + "      <br/><br/>"
				...
				+ "      Come Shop Again! <br/<br/> <font style=\"color:green;font-weight:bold;\"> UPES MART</font>"
				+ "    </p>" + "    " + "  </body>" + "</html>";
	...
	public static void orderShipped(String recipientEmail, String name, String transId, double transAmount) {
		String recipient = recipientEmail;
		String subject = "Hurray!!, Your Order has been Shipped from UPES MART";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with UPES MART" + "      <br/><br/>"
	...
	public static void productAvailableNow(String recipientEmail, String name, String prodName, String prodId) {
		String recipient = recipientEmail;
		String subject = "Product " + prodName + " is Now Available at UPES MART";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with UPES MART!" + "      <br/><br/>"
				...
				+ "      Come Shop Again! <br/<br/><br/> <font style=\"color:green;font-weight:bold;\">UPES MART</font>"
				+ "    </p>" + "    " + "  </body>" + "</html>";
